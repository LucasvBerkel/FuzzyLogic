...
parser.add_argument("-t", help="Threshold for amount of reviews per user", type=int)
parser.add_argument("-d", help="Delete user below threshold, yes or no", type=str)
...
if __name__ == "__main__":
	...
	newPath = "training_set_without_old_reviews_impopular_movies_inactive_users/"
